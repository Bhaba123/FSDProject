...
public class UserFileRunner {
	UserFileRunner Userfiles;

	public static void main(String[] args) {
	UserFileRunner userfilesrunner =new UserFileRunner();
	...
	try (Scanner input = new Scanner(System.in)) {
		...
		System.out.println("**********************************Bhabananda Prusty***********************************************************");
		System.out.println();
	...
	try (Scanner input = new Scanner(System.in)) {
		...
		case 2:
		System.out.println("Option 2 Selected");
		this.Userfiles.createuserFile(); break;

		case 3:
		System.out.println("Option 3 Selected");
		this.Userfiles.searchFile(); break;
